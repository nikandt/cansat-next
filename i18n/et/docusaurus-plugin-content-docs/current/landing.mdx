...
If you are new here, head to [Getting Started Page](./course/course.md) for information on how to start using CanSat NeXT. You may also be interested in information of making the basic antenna from the materials included with the kit. For that, head to article [Communication and Antennas](./CanSat-hardware/communication).
...
Finally, if you are anything like me, you probably came to this page looking for [the library specification](./CanSat-software/library_specification) or the pinout. More information about that in [Pinout](./CanSat-hardware/pin_out), but here is a quick reference:
